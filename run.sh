...
git clone --depth=1 https://github.com/danielbayu/odoo-18-docker-compose $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: *#Oke123#* | Live chat port: $CHAT"
